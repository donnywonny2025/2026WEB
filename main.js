...
function getEmbedUrl(project) {
    if (project.embed === 'youtube') {
        return `https://www.youtube-nocookie.com/embed/${project.videoId}?autoplay=1&mute=1&loop=1&playlist=${project.videoId}&rel=0&modestbranding=1&playsinline=1&vq=hd1080&color=white&iv_load_policy=3`;
    }
...
function populateDetail(index) {
    ...
    newIframe.width = '1920'; // Force YouTube to load HD stream
